...
<head>
	...
	<style>
		...
		.owl-dots{
			...
			left: 50%;
			transform: translateX(-50%); /* Memastikan titik tengah */
			/* display: flex;
			justify-content: center;
			align-items: center; */
			gap: 5px; /* Jarak antar tombol */
			width: auto; /* Hindari lebar penuh agar tombol tetap di tengah */
		}
		/* #hero {
			...
			<div class="branding d-flex align-items-center">
				...
				<div class="container position-relative d-flex align-items-center justify-content-between">
					...
					<nav id="navmenu" class="navmenu">
						<ul>
							<li><a href="javascript:void(0)" class="fs-4 fw-bold active"><span>Beranda</span></a></li>
							<li class="dropdown"><a href="javascript:void(0)" class="fs-4 fw-bold"><span>Profil</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
								<ul>
									<li><a href="javascript:void(0)" class="fs-5">Visi dan Misi</a></li>
									<li><a href="javascript:void(0)" class="fs-5">Tugas Pokok dan Fungsi</a></li>
								</ul>
							</li>
							<li class="dropdown"><a href="javascript:void(0)" class="fs-4 fw-bold"><span>Pelayanan</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
								<ul>
									<li><a href="javascript:void(0)" class="fs-5">Jadwal Poli Klinik</a></li>
								</ul>
							</li>
							<li class="dropdown"><a href="javascript:void(0)" class="fs-4 fw-bold"><span>Informasi</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
								<ul>
									<li><a href="javascript:void(0)" class="fs-5">Berita</a></li>
									<li><a href="javascript:void(0)" class="fs-5">Pengumuman</a></li>
								</ul>
							</li>
							<li><a href="javascript:void(0)" class="fs-4 fw-bold"><span>Kontak</span></a></li>
						</ul>
			...
			">
				...
				{{-- <div class="container position-relative"> --}}
					{{-- <div class="owl-carousel">
						<div> <img height="50px" width="auto" src="https://gratisography.com/wp-content/uploads/2024/11/gratisography-augmented-reality-800x525.jpg" alt=""> </div>
					</div> --}}
